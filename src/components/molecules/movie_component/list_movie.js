...
function MovieCPN({title,title2,titleHome,titleHome2,limit=6,imgSize=false}) {
                    ...
                    <Card
                      ...
                      cover={
                        <div className="box-mask">
                          <img className="img_medium" width="400px" src={imgSize ? item.image_large : item.img_medium } alt="img" />
