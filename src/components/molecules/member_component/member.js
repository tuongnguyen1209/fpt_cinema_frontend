                ...
                <div className="main_member">
                    ...
                    <div>
                        <div className="div-container top-container">
                            <h4>THỂ LỆ</h4>
                            <p>Chương trình khách hàng thân thiết Galaxy là chương trình ưu đãi dựa trên điểm tích lũy của các thành viên gồm Star, G-star, X-star.
                            Với mỗi giao dịch tại hệ thống rạp Galaxy, bạn sẽ nhận được điểm thưởng tương ứng. Hình thức tích lũy như sau:</p>
                            <div className="div-img"><Image
                                width={600}
                                src="
                        ...
                        <div className="div-container">
                            ...
                            <p>Từ 0.1 đến 0.4: làm tròn xuống (Ví dụ: 3.2 sao sẽ được tích vào tài khoản 3 sao)<br></br>
                            Từ 0.5 đến 0.9: làm tròn lên (Ví dụ: 3.5 sao sẽ được tích vào tài khoản 4 sao)</p>
                        </div>

                        <div className="div-container">
                            <h4>Cấp độ thành viên</h4>
                            <div className="div-img img2"><Image
                                width={600}
                                src="
                                https://www.galaxycine.vn/media/2019/12/18/thanh-tinh-diem_1576655615185.jpg"
                            /></div>
                            <p><b>Star</b> là thành viên thân thiết có tổng chi tiêu trong năm dưới 2,000,000 đồng tính từ ngày 1/1-31/12. <br></br>
                            <b>G-star</b> là thành viên thân thiết có tổng chi tiêu trong năm từ 2,000,000 đồng đến 3,999,999 đồng tính từ ngày 1/1-31/12.<br></br>
                            <b>X-star</b> là thành viên thân thiết có tổng chi tiêu từ 4,000,000 đồng trở lên tính từ ngày 1/1-31/12</p>
                        </div>

                        <div className="div-container">
                            <h4>Chính sách đổi quà</h4>
                            <div className="div-img img3"><Image
                                width={600}
                                src="
                        ...
                        <div className="div-container">
                            ...
                            <ul>
                                ...
                                <li>Điểm tích lũy có thời hạn sử dụng là 01 năm (tính từ ngày 01/01/2021-31/12/2021).</li>
